"""
AROMI AI Backend - Complete Working Solution
...
app = FastAPI(
    title="AROMI AI API",
    version="3.0.0",
    description="Next-Gen AI Wellness Platform with Real API Integration"
)
...
def read_root():
    return {
        ...
        "version": "3.0.0",
        "features": ["Real Groq AI", "Spoonacular API", "Complete Integration"]
    }
...
async def ai_chat(request: ChatRequest):
    """AROMI AI Chat - Wellness coaching with Groq AI"""
    try:
...
async def coach_chat(message: str):
    ...
    try:
        chat_data = await chat_with_grok_ai(message)
        return {
            "platform": "AROMI AI",
            "success": True,
            "user_message": chat_data["user_message"],
        ...
        return {
            ...
            "success": True,
            "user_message": message,
            "ai_response": "AROMI AI: I'm your wellness coach! I recommend staying hydrated, exercising regularly, and maintaining a balanced diet.",
            "timestamp": datetime.utcnow(),
            "generated_by": "AROMI AI"
        }
