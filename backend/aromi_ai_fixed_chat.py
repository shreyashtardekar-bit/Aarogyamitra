"""
AROMI AI Backend - Fixed Chatbot
...
app = FastAPI(
    title="AROMI AI API",
    version="3.1.0",
    description="Next-Gen AI Wellness Platform with Fixed Chatbot"
)
...
async def chat_with_grok_ai(message: str, context: str = None) -> dict:
    """Chat with Groq AI - FIXED VERSION"""
    try:
        headers = {
            "Authorization": f"Bearer {GROQ_API_KEY}",
            "Content-Type": "application/json"
...
def read_root():
    return {
        ...
        "version": "3.1.0",
        "features": ["Real Groq AI", "Spoonacular API", "Fixed Chatbot", "Complete Integration"]
    }
...
async def ai_chat(request: ChatRequest):
    """AROMI AI Chat - Wellness coaching with Groq AI - FIXED"""
    try:
...
async def coach_chat(request: ChatRequest):
    """Coach chat endpoint for frontend compatibility - FIXED"""
    try:
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 AROMI AI FIXED BACKEND STARTING")
    ...
    print("✅ Chatbot: FIXED AND WORKING")
