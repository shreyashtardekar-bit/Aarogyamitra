...
export default function AROMIComplete() {
    ...
    try {
      ...
      if (data.success && data.platform === 'AROMI AI') {
        const newChat = {
          ...
          message: chatMessage,
          response: data.chat_response.ai_response,
          generated_by: data.chat_response.generated_by
        };
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mt-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-green-600 font-semibold">
                {chatHistory.length > 0 ? '✅ Working' : 'Ready'}
              </p>
            </div>
          </div>
        </div>
